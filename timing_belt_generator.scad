...
module belt_tooth(tooth_profile = undef, belt_width = undef)
{
	...
	else if( tooth_profile == "S3M" ) {S3M(width = belt_width);}
...
module S3M(width = 2)
{
	linear_extrude(height=width) polygon([[-1.14,-0.6],[-1.14,0],[-1.065,0.025],[-0.995,0.095],[-0.945,0.205],[-0.92,0.34],[-0.615,0.965],[-0.585,1.04],[-0.54,1.105],[-0.48,1.16],[-0.41,1.205],[-0.33,1.24],[-0.245,1.265],[-0.155,1.28],[-0.065,1.285],[0,1.286],[0.065,1.285],[0.155,1.28],[0.245,1.265],[0.33,1.24],[0.41,1.205],[0.48,1.16],[0.54,1.105],[0.585,1.04],[0.615,0.965],[0.92,0.34],[0.945,0.205],[0.995,0.095],[1.065,0.025],[1.14,0],[1.14,-0.6]]);
}
